  ...
  return (
    <li className="flex items-start gap-3 text-sm" style={{ color: '#CBD5E1' }}>
      <svg width="18" height="18" viewBox="0 0 18 18" fill="none" className="shrink-0 mt-0.5">
        <circle cx="9" cy="9" r="9" fill="rgba(99,102,241,0.15)" />
        <path d="M5.5 9l2.5 2.5 4.5-4.5" stroke="#6366F1" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
      <span>{children}</span>
    </li>
  )
  ...
  return (
    <>
      ...
      >
        ...
        <circle cx={-3} cy={-3} r={2.8} fill="rgba(255,255,255,0.22)" />
      </motion.g>
    </>
  )
}
...
const OfficeMapAnimation = memo(function OfficeMapAnimation() {
  ...
  const zones = [
    { x: 24,  y: 24,  w: 220, h: 150, fill: 'rgba(99,102,241,0.13)',  stroke: 'rgba(99,102,241,0.38)',  accent: '#6366F1', label: 'Open Space'  },
    { x: 260, y: 24,  w: 148, h: 70,  fill: 'rgba(34,211,238,0.13)',  stroke: 'rgba(34,211,238,0.38)',  accent: '#22D3EE', label: 'Salle Alpha'  },
    { x: 260, y: 104, w: 148, h: 70,  fill: 'rgba(34,211,238,0.13)',  stroke: 'rgba(34,211,238,0.38)',  accent: '#22D3EE', label: 'Salle Bêta'   },
    { x: 24,  y: 190, w: 128, h: 100, fill: 'rgba(16,185,129,0.13)',  stroke: 'rgba(16,185,129,0.38)',  accent: '#10B981', label: 'Focus'        },
    { x: 168, y: 190, w: 110, h: 100, fill: 'rgba(245,158,11,0.13)',  stroke: 'rgba(245,158,11,0.38)',  accent: '#F59E0B', label: 'Café'         },
    { x: 294, y: 190, w: 114, h: 100, fill: 'rgba(139,92,246,0.13)',  stroke: 'rgba(139,92,246,0.38)',  accent: '#8B5CF6', label: 'Social'       },
  ]
  ...
  const avatars: {
    ...
    { paths: [[80, 80], [150, 68], [118, 126]],  color: '#6366F1', statusColor: '#22C55E', speaking: false, delay: 0 },
    ...
    { paths: [[88, 240]],                         color: '#6366F1', statusColor: '#EAB308', speaking: false, delay: 0 },
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="ml-3 text-xs font-medium" style={{ color: '#374151' }}>
      ...
      <svg viewBox="0 0 432 308" className="w-full" style={{ display: 'block' }}>
        <defs>
          <pattern id={gridId} x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
            <circle cx="1" cy="1" r="0.75" fill="rgba(255,255,255,0.07)" />
          </pattern>
        </defs>
        ...
        {zones.map((z, i) => (
          <g key={i}>
            ...
            <rect x={z.x + 10} y={z.y} width={z.w - 20} height={2.5} rx={1.5} fill={z.accent} opacity={0.8} />
            <text
              x={z.x + z.w / 2}
              y={z.y + z.h - 9}
              textAnchor="middle"
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="w-3 h-3 rounded-full" style={{ background: '#FFBD2E' }} />
        <div className="w-3 h-3 rounded-full" style={{ background: '#28CA41' }} />
        <span className="ml-3 text-xs font-medium" style={{ color: '#374151' }}>Audio spatial</span>
      </div>
      ...
      <svg viewBox="0 0 340 180" className="w-full" style={{ display: 'block' }}>
        ...
        <line x1="100" y1="90" x2="218" y2="90" stroke="rgba(34,211,238,0.3)" strokeWidth="1.5" strokeDasharray="5 4" />
        <text x="159" y="82" textAnchor="middle" fontSize="9" fill="rgba(34,211,238,0.65)" fontFamily="'DM Sans', sans-serif">
          proche →
        </text>

        {/* Listener avatar */}
        <g transform="translate(100,90)">
          <circle r={11} fill="#6366F1" />
      ...
      >
        <span className="flex items-center gap-1.5">
          <span className="w-2.5 h-2.5 rounded-full inline-block" style={{ background: '#6366F1' }} /> Vous
        </span>
        <span className="flex items-center gap-1.5">
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="w-3 h-3 rounded-full" style={{ background: '#FFBD2E' }} />
        <div className="w-3 h-3 rounded-full" style={{ background: '#28CA41' }} />
        <span className="ml-3 text-xs font-medium" style={{ color: '#374151' }}>Intégration Microsoft Teams</span>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-6 p-8">
        <div className="flex items-center gap-5 w-full max-w-xs">
          ...
          <div
            ...
            style={{ background: 'rgba(80,89,201,0.1)', border: '1px solid rgba(80,89,201,0.25)' }}
          >
            <div
            ...
            <div className="min-w-0">
              <div className="text-xs font-semibold" style={{ color: '#E2E8F0' }}>Teams</div>
          ...
          <motion.div animate={{ x: [0, 5, 0] }} transition={{ duration: 1.4, repeat: Infinity, ease: 'easeInOut' }} className="shrink-0">
            <svg width="22" height="14" viewBox="0 0 22 14" fill="none">
              <path d="M1 7h16M13 1l6 6-6 6" stroke="#6366F1" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </motion.div>
          ...
          >
            <div className="relative shrink-0">
              <div className="w-9 h-9 rounded-full flex items-center justify-center text-sm font-bold text-white" style={{ background: 'linear-gradient(135deg,#6366F1,#818CF8)' }}>
                M
              </div>
              <motion.div animate={{ backgroundColor: color }} transition={{ duration: 0.35 }} className="absolute -bottom-0.5 -right-0.5 w-3.5 h-3.5 rounded-full border-2" style={{ borderColor: '#0C0C14' }} />
            </div>
            <div className="min-w-0">
              <div className="text-xs font-semibold" style={{ color: '#E2E8F0' }}>MonPlateau</div>
              <AnimatePresence mode="wait">
                <motion.div key={current} initial={{ opacity: 0, y: 3 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -3 }} transition={{ duration: 0.22 }} className="text-[10px]" style={{ color }}>
                  {current}
                </motion.div>
    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 flex items-center justify-between h-16">
        <Link href="/" className="flex items-center gap-2.5 no-underline">
          <LogoMark size={30} />
          <span style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700, fontSize: 17, color: '#F1F5F9' }}>
            MonPlateau
          </span>
        </Link>
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            style={{ background: 'rgba(10,10,15,0.96)', borderBottom: '1px solid rgba(255,255,255,0.06)' }}
          >
            <div className="px-5 py-5 flex flex-col gap-4">
              {navLinks.map(({ label, href }) => (
                <a key={label} href={href} className="text-sm no-underline" style={{ color: '#CBD5E1' }} onClick={() => setOpen(false)}>
                  {label}
                </a>
              ))}
              <Link
...
function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden" style={{ background: '#0A0A0F' }}>
      {/* Gradient blobs */}
      <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute rounded-full" style={{ width: 800, height: 800, top: '-25%', left: '-18%', background: 'radial-gradient(circle,rgba(99,102,241,0.11) 0%,transparent 65%)', filter: 'blur(60px)' }} />
        <div className="absolute rounded-full" style={{ width: 600, height: 600, bottom: '-15%', right: '-10%', background: 'radial-gradient(circle,rgba(34,211,238,0.07) 0%,transparent 65%)', filter: 'blur(60px)' }} />
      </div>
      ...
      <div
        ...
        style={{ backgroundImage: 'radial-gradient(circle,#1E1E2E 1px,transparent 1px)', backgroundSize: '40px 40px', opacity: 0.55 }}
      />
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="flex flex-col gap-7">
            ...
            <motion.p
              ...
              style={{ fontSize: 19, color: '#94A3B8', lineHeight: 1.65, maxWidth: 480, margin: 0 }}
            >
            ...
            >
              <Link
                ...
                style={{
                  background: 'linear-gradient(135deg,#6366F1,#818CF8)',
                  color: '#fff',
                  boxShadow: '0 0 28px rgba(99,102,241,0.38), 0 4px 20px rgba(0,0,0,0.3)',
                }}
              >
...
function FeatureSection({
  ...
  return (
    <section id={id} className="py-24" style={{ background: '#0A0A0F', borderTop: '1px solid rgba(255,255,255,0.04)' }}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className={flip ? 'lg:order-2' : ''}>
            <FadeUp><SectionBadge>{badge}</SectionBadge></FadeUp>
            <FadeUp delay={0.1} className="mt-4">
              <h2 style={{ fontFamily: "'Syne', sans-serif", fontSize: 'clamp(26px, 3.5vw, 42px)', fontWeight: 700, color: '#F1F5F9', lineHeight: 1.2, letterSpacing: '-0.02em', margin: 0 }}>
                {title}
              </h2>
            </FadeUp>
            <FadeUp delay={0.16} className="mt-4">
              <p style={{ color: '#94A3B8', lineHeight: 1.72, fontSize: 16, margin: 0 }}>{description}</p>
            </FadeUp>
...
function HowItWorksSection() {
  ...
  return (
    <section id="about" className="py-28 relative overflow-hidden" style={{ background: 'linear-gradient(180deg,#0A0A0F 0%,#0E0E1C 55%,#0A0A0F 100%)' }}>
      <div aria-hidden className="pointer-events-none absolute inset-0" style={{ background: 'radial-gradient(ellipse at 50% 45%,rgba(99,102,241,0.07) 0%,transparent 70%)' }} />

      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6">
        <FadeUp className="text-center mb-16">
          <h2 style={{ fontFamily: "'Syne', sans-serif", fontSize: 'clamp(26px, 4vw, 48px)', fontWeight: 700, color: '#F1F5F9', letterSpacing: '-0.02em', margin: '0 0 12px' }}>
            Opérationnel en <span style={{ color: '#6366F1' }}>3 minutes</span>
          </h2>
          <p style={{ color: '#64748B', fontSize: 16, margin: 0 }}>Pas d&apos;installation. Pas de configuration complexe.</p>
        </FadeUp>
        ...
        <div className="relative grid md:grid-cols-3 gap-6">
          <div
            ...
            style={{ top: '2.4rem', left: 'calc(16.67% + 32px)', right: 'calc(16.67% + 32px)', height: 1, background: 'linear-gradient(90deg,transparent,rgba(99,102,241,0.35) 30%,rgba(99,102,241,0.35) 70%,transparent)' }}
          />
          {steps.map((step, i) => (
            <FadeUp key={i} delay={i * 0.11}>
              <div className="relative flex flex-col gap-4 p-6 rounded-2xl h-full" style={{ background: '#13131A', border: '1px solid rgba(255,255,255,0.06)' }}>
                <div className="flex items-center justify-between">
                  <div className="w-11 h-11 rounded-xl flex items-center justify-center" style={{ background: 'rgba(99,102,241,0.1)', border: '1px solid rgba(99,102,241,0.18)' }}>
                    {step.icon}
                  </div>
                  <span style={{ fontFamily: "'Syne', sans-serif", fontSize: 34, fontWeight: 800, color: 'rgba(99,102,241,0.14)', lineHeight: 1 }}>{step.num}</span>
                </div>
                <h3 style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700, color: '#F1F5F9', fontSize: 15, margin: 0 }}>{step.title}</h3>
                <p style={{ color: '#64748B', fontSize: 13.5, lineHeight: 1.65, margin: 0 }}>{step.desc}</p>
              </div>
            </FadeUp>
          ))}
        </div>
...
function PricingSection() {
  ...
  return (
    <section id="pricing" className="py-24" style={{ background: '#0A0A0F', borderTop: '1px solid rgba(255,255,255,0.04)' }}>
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <FadeUp className="text-center mb-3">
          <h2 style={{ fontFamily: "'Syne', sans-serif", fontSize: 'clamp(26px, 4vw, 48px)', fontWeight: 700, color: '#F1F5F9', letterSpacing: '-0.02em', margin: 0 }}>
            Simple et transparent
          </h2>
        </FadeUp>
        <FadeUp delay={0.1} className="text-center mb-10">
          <p style={{ color: '#64748B', fontSize: 16, margin: '12px 0 0' }}>Pas de frais cachés. Changez de plan à tout moment.</p>
        </FadeUp>

        <FadeUp delay={0.14} className="flex justify-center mb-10">
          <div className="flex items-center gap-1 p-1 rounded-lg" style={{ background: '#13131A', border: '1px solid rgba(255,255,255,0.06)' }}>
            {([{ label: 'Mensuel', val: false }, { label: 'Annuel', val: true, badge: '−20%' }] as { label: string; val: boolean; badge?: string }[]).map(({ label, val, badge }) => (
              <button key={label} onClick={() => setAnnual(val)} className="flex items-center gap-2 px-4 py-1.5 rounded-md text-sm font-medium transition-all duration-150" style={{ background: annual === val ? '#1E1E2E' : 'transparent', color: annual === val ? '#F1F5F9' : '#64748B' }}>
                {label}
                {badge && <span className="text-[10px] px-1.5 py-0.5 rounded-full" style={{ background: 'rgba(99,102,241,0.18)', color: '#818CF8' }}>{badge}</span>}
              </button>
            ))}
          </div>
        </FadeUp>
          ...
          {plans.map((plan, i) => (
            <FadeUp key={i} delay={i * 0.09}>
              <div
                ...
                style={{
                  background: plan.highlight ? 'linear-gradient(160deg,#18183A,#13131A)' : '#13131A',
                  border: plan.highlight ? '1px solid rgba(99,102,241,0.45)' : '1px solid rgba(255,255,255,0.06)',
                  boxShadow: plan.highlight ? '0 0 40px rgba(99,102,241,0.13)' : 'none',
                }}
              >
                {plan.highlight && <div className="absolute top-0 inset-x-0 h-px" style={{ background: 'linear-gradient(90deg,transparent,#6366F1 50%,transparent)' }} />}
                {plan.highlight && (
                  <div className="absolute top-4 right-4">
                    <span className="text-[10px] font-semibold px-2.5 py-1 rounded-full" style={{ background: 'rgba(99,102,241,0.2)', color: '#818CF8', border: '1px solid rgba(99,102,241,0.3)' }}>Populaire</span>
                  </div>
                )}
                <div>
                  <h3 style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700, color: '#F1F5F9', fontSize: 18, margin: 0 }}>{plan.name}</h3>
                  <p className="mt-1 text-sm" style={{ color: '#64748B' }}>{plan.sub}</p>
                </div>
                <div className="flex items-end gap-1">
                  <span style={{ fontFamily: "'Syne', sans-serif", fontSize: plan.price === 'Sur devis' ? 22 : 36, fontWeight: 800, color: '#F1F5F9', lineHeight: 1 }}>{plan.price}</span>
                  {plan.period && <span className="text-xs pb-1.5" style={{ color: '#64748B' }}>{plan.period}</span>}
                </div>
                <ul className="flex flex-col gap-2.5 flex-1">
                  {plan.features.map((f, fi) => (
                    <li key={fi} className="flex items-center gap-2.5 text-sm" style={{ color: '#CBD5E1' }}>
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" className="shrink-0">
                        <circle cx="8" cy="8" r="8" fill={plan.highlight ? 'rgba(99,102,241,0.18)' : 'rgba(255,255,255,0.05)'} />
                        <path d="M4.5 8l2.5 2.5 4.5-4.5" stroke={plan.highlight ? '#818CF8' : '#6B7280'} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                      </svg>
                      {f}
                    </li>
                  ))}
                ...
                <Link href="/auth/login" className="flex items-center justify-center h-10 rounded-xl text-sm font-semibold no-underline transition-all duration-200"
                  style={plan.highlight ? { background: 'linear-gradient(135deg,#6366F1,#818CF8)', color: '#fff', boxShadow: '0 0 18px rgba(99,102,241,0.3)' } : { background: 'rgba(255,255,255,0.04)', color: '#E2E8F0', border: '1px solid rgba(255,255,255,0.08)' }}>
                  {plan.cta}
                </Link>
              </div>
            </FadeUp>
...
function CTABanner() {
  return (
    <section className="py-28 relative overflow-hidden" style={{ background: 'linear-gradient(180deg,#0A0A0F 0%,#0D0D1C 55%,#0A0A0F 100%)', borderTop: '1px solid rgba(255,255,255,0.04)' }}>
      <div aria-hidden className="pointer-events-none absolute inset-0" style={{ background: 'radial-gradient(ellipse at 50% 60%,rgba(99,102,241,0.16) 0%,transparent 65%)' }} />
      <div className="relative z-10 max-w-2xl mx-auto px-4 sm:px-6 text-center">
        <FadeUp>
          <h2 style={{ fontFamily: "'Syne', sans-serif", fontSize: 'clamp(26px, 4.5vw, 52px)', fontWeight: 800, color: '#F1F5F9', lineHeight: 1.15, letterSpacing: '-0.025em', margin: 0 }}>
        ...
        <FadeUp delay={0.12} className="mt-5">
          <p style={{ color: '#64748B', fontSize: 18, margin: 0 }}>Essai gratuit 30 jours. Sans carte bancaire.</p>
        </FadeUp>
        <FadeUp delay={0.22} className="mt-9">
          <Link
            ...
            style={{ background: 'linear-gradient(135deg,#6366F1,#818CF8)', color: '#fff', boxShadow: '0 0 48px rgba(99,102,241,0.38), 0 8px 28px rgba(0,0,0,0.32)' }}
          >
...
function Footer() {
  ...
  return (
    <footer className="py-16" style={{ borderTop: '1px solid rgba(255,255,255,0.05)', background: '#0A0A0F' }}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          <div>
            <div className="flex items-center gap-2.5 mb-4">
              <LogoMark size={26} />
              <span style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700, color: '#F1F5F9', fontSize: 15 }}>MonPlateau</span>
            </div>
            <p className="text-sm" style={{ color: '#475569', lineHeight: 1.65 }}>Votre bureau virtuel, réinventé pour les équipes hybrides modernes.</p>
          </div>
          {cols.map((col) => (
            <div key={col.title}>
              <h4 className="text-[10px] font-semibold uppercase tracking-widest mb-4" style={{ color: '#475569' }}>{col.title}</h4>
              <ul className="flex flex-col gap-2.5">
                {col.links.map((link) => (
                  <li key={link}>
                    <a href="#" className="text-sm no-underline transition-colors duration-150" style={{ color: '#64748B' }} onMouseEnter={(e) => (e.currentTarget.style.color = '#94A3B8')} onMouseLeave={(e) => (e.currentTarget.style.color = '#64748B')}>{link}</a>
                  </li>
                ))}
              </ul>
            </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-3 pt-8 text-sm" style={{ borderTop: '1px solid rgba(255,255,255,0.05)', color: '#475569' }}>
...
export default function LandingPage() {
  return (
    <main style={{ background: '#0A0A0F', color: '#F1F5F9', fontFamily: "'DM Sans', sans-serif" }}>
      <Navbar />
      <HeroSection />
      <FeatureSection
        id="features"
